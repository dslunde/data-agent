...
class LLMManager:
    ...
    def __init__(self, preferred_provider: str = "auto"):
        ...
        logger.info(f"LLM Manager initialized with provider: {self.current_client.__class__.__name__ if self.current_client else 'None'}")
    ...
    def _set_current_client(self):
        ...
        if self.preferred_provider == "auto":
            ...
            if self.preferred_provider in self.clients:
                ...
                logger.error(f"Preferred provider {self.preferred_provider} not available")
                self.current_client = None
...
def test_llm_connectivity() -> Dict[str, Any]:
    ...
    try:
        if OPENAI_AVAILABLE and os.getenv("OPENAI_API_KEY"):
            ...
            results["openai"]["error"] = "API key not available or package not installed"
    except Exception as e:
    ...
    try:
        if ANTHROPIC_AVAILABLE and os.getenv("ANTHROPIC_API_KEY"):
            ...
            results["anthropic"]["error"] = "API key not available or package not installed"
    except Exception as e:
